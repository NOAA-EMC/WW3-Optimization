...
u1_varid=netcdf.defVar(nc, 'wind_dir' ,'NC_FLOAT',[timet,nnstat]);
...
u2_varid=netcdf.defVar(nc, 'wind_spd' ,'NC_FLOAT',[timet,nnstat]);
...
u3_varid=netcdf.defVar(nc, 'gust' ,'NC_FLOAT',[timet,nnstat]);
...
u4_varid=netcdf.defVar(nc, 'wave_height' ,'NC_FLOAT',[timet,nnstat]);
...
u5_varid=netcdf.defVar(nc, 'dominant_wpd' ,'NC_FLOAT',[timet,nnstat]);
...
u6_varid=netcdf.defVar(nc, 'average_wpd' ,'NC_FLOAT',[timet,nnstat]);
...
u7_varid=netcdf.defVar(nc, 'mean_wave_dir' ,'NC_FLOAT',[timet,nnstat]);
...
u8_varid=netcdf.defVar(nc, 'air_pressure' ,'NC_FLOAT',[timet,nnstat]);
...
u9_varid=netcdf.defVar(nc, 'air_temperature' ,'NC_FLOAT',[timet,nnstat]);
...
u10_varid=netcdf.defVar(nc, 'sea_surface_temperature' ,'NC_FLOAT',[timet,nnstat]);
...
u11_varid=netcdf.defVar(nc, 'dewpt_temperature' ,'NC_FLOAT',[timet,nnstat]);
...
u12_varid=netcdf.defVar(nc, 'visibility' ,'NC_FLOAT',[timet,nnstat]);
...
u13_varid=netcdf.defVar(nc, 'water_level' ,'NC_FLOAT',[timet,nnstat]);
...
fileattrib(ncfile,'+w');
ncwriteatt(ncfile,'latitude','_FillValue', int32(999));
ncwriteatt(ncfile,'longitude','_FillValue', int32(999));
ncwriteatt(ncfile,'wind_dir','_FillValue', int32(999));
ncwriteatt(ncfile,'wind_spd','_FillValue', int32(999));
ncwriteatt(ncfile,'gust','_FillValue', int32(999));
ncwriteatt(ncfile,'wave_height','_FillValue', int32(999));
ncwriteatt(ncfile,'dominant_wpd','_FillValue', int32(999));
ncwriteatt(ncfile,'average_wpd','_FillValue', int32(999));
ncwriteatt(ncfile,'mean_wave_dir','_FillValue', int32(999));
ncwriteatt(ncfile,'air_pressure','_FillValue', int32(999));
ncwriteatt(ncfile,'air_temperature','_FillValue', int32(999));
ncwriteatt(ncfile,'sea_surface_temperature','_FillValue', int32(999));
ncwriteatt(ncfile,'dewpt_temperature','_FillValue', int32(999));
ncwriteatt(ncfile,'visibility','_FillValue', int32(999));
ncwriteatt(ncfile,'water_level','_FillValue', int32(999));
